        ...
        <div className="flex items-center justify-between py-2">
          ...
          <div className="flex items-center space-x-4">
            ...
            <nav className="hidden md:flex space-x-4">
              <Link
                href={`/`}
                className="hover:shadow-lg transition-colors rounded-xl bg-white/10 backdrop-blur-md border p-2 text-sm shadow-sm shadow-color22"
              >
                Home
              </Link>
            ...
            <a
              href={`/cart`}
              className="relative flex items-center space-x-2 hover:shadow-lg transition-colors rounded-xl bg-white/10 backdrop-blur-md border  p-2 text-sm shadow-sm shadow-color22"
            >
